...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( AuthCheckEvent value)?  checkAuth,TResult Function( AuthSetEvent value)?  setAuth,TResult Function( AuthLogoutEvent value)?  logout,required TResult orElse(),}){
final _that = this;
switch (_that) {
case AuthCheckEvent() when checkAuth != null:
return checkAuth(_that);case AuthSetEvent() when setAuth != null:
return setAuth(_that);case AuthLogoutEvent() when logout != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( AuthCheckEvent value)  checkAuth,required TResult Function( AuthSetEvent value)  setAuth,required TResult Function( AuthLogoutEvent value)  logout,}){
final _that = this;
switch (_that) {
case AuthCheckEvent():
return checkAuth(_that);case AuthSetEvent():
return setAuth(_that);case AuthLogoutEvent():
return logout(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( AuthCheckEvent value)?  checkAuth,TResult? Function( AuthSetEvent value)?  setAuth,TResult? Function( AuthLogoutEvent value)?  logout,}){
final _that = this;
switch (_that) {
case AuthCheckEvent() when checkAuth != null:
return checkAuth(_that);case AuthSetEvent() when setAuth != null:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  checkAuth,TResult Function()?  setAuth,TResult Function( bool fromInterceptor)?  logout,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AuthCheckEvent() when checkAuth != null:
return checkAuth();case AuthSetEvent() when setAuth != null:
return setAuth();case AuthLogoutEvent() when logout != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  checkAuth,required TResult Function()  setAuth,required TResult Function( bool fromInterceptor)  logout,}) {final _that = this;
switch (_that) {
case AuthCheckEvent():
return checkAuth();case AuthSetEvent():
return setAuth();case AuthLogoutEvent():
return logout(_that.fromInterceptor);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  checkAuth,TResult? Function()?  setAuth,TResult? Function( bool fromInterceptor)?  logout,}) {final _that = this;
switch (_that) {
case AuthCheckEvent() when checkAuth != null:
return checkAuth();case AuthSetEvent() when setAuth != null:
return setAuth();case AuthLogoutEvent() when logout != null:
...
class AuthSetEvent with DiagnosticableTreeMixin implements AuthEvent {
  const AuthSetEvent();
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ..add(DiagnosticsProperty('type', 'AuthEvent.setAuth'))
    ;
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthSetEvent);
}
